...
# $(EXTENSION) extension
comment = '$(EXTENSION) - adds an event trigger that intercepts ALTER TABLE ADD CONSTRAINT clause forcing it to skip validation of the constraint'
...
test:
	pg_prove $(ARGS) -a ./tap_results/ $(TESTS) --dbname test_evt
